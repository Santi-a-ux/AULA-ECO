...
async function main(){
  ...
  try {
    ...
    const materials = ['Tetra Pak','Plástico PP','Aluminio','Otro','Cartón'];
    ...
    for (const u of users) {
      for (let i=0;i<10;i++) {
        // spread across last 365 days and different months/hours
      ...
      console.log(`Inserted 10 records for user ${u.id} (${u.username})`);
    }
